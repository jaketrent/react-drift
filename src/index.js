...
import slideOverride from './slide-override.css'
    ...
    return (
      <Frame>
        <Carousel showIndex={this.state.showIndex}>
          ...
          <Slide css={slideOverride} image={require('./images/1.jpg')} title="Imperial Mockery">
          ...
          <Slide css={slideOverride} image={require('./images/2.jpg')} title="Trooper Initiation">
          ...
          <Slide css={slideOverride} image={require('./images/3.jpg')} title="Master and Apprentice">
          ...
          <Slide css={slideOverride} image={require('./images/4.jpg')} title="Battle of Coruscant">
          ...
          <Slide css={slideOverride} image={require('./images/5.jpg')} title="The Wiles of the Forest">
