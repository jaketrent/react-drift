      ...
      <Frame>
        ...
        >
          <Slide image={require('./images/1.jpg')} title="Imperial Mockery">
            ...
            that is service to the Empire.
            These objects were immediately removed from the reflecting pool in
            Coruscant's Central Square when found
            this morning.
          </Slide>
          <Slide image={require('./images/2.jpg')} title="Trooper Initiation">
            ...
            to suffer the agony of
            the limbo line. Such initiation techniques are currently under
            Imperial review.
          </Slide>
          <Slide
          ...
          >
            ...
            first find someone currently in that line of
            work. They will likely be able to show you what it's really like
            before you commit your future.
          </Slide>
          <Slide image={require('./images/4.jpg')} title="Battle of Coruscant">
            ...
            reenactment of the Battle of Coruscant.
          ...
          >
            ...
            rotating troopers stationed on the forest moons of Endor after
            several rotations.
          </Slide>
        </Carousel>
      </Frame>
